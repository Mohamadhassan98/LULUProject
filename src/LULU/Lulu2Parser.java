...
public class Lulu2Parser extends Parser {
	...
	public static final int
		...
		ID=65, WhiteSpace=66;
	public static final int
		RULE_main = 0, RULE_ftDcl = 1, RULE_funcDcl = 2, RULE_typeBrace = 3, RULE_args = 4, 
		RULE_argsVar = 5, RULE_typeDcl = 6, RULE_varDef = 7, RULE_varVal = 8, 
		RULE_ftDef = 9, RULE_typeDef = 10, RULE_component = 11, RULE_accessModifier = 12, 
		RULE_funcDef = 13, RULE_block = 14, RULE_stmt = 15, RULE_assign = 16, 
		RULE_var = 17, RULE_ref = 18, RULE_expr = 19, RULE_funcCall = 20, RULE_list = 21, 
		RULE_handleCall = 22, RULE_params = 23, RULE_condStmt = 24, RULE_loopStmt = 25, 
		RULE_type = 26, RULE_constVal = 27, RULE_unaryOp = 28, RULE_firstLevelBinaryArithmeticOp = 29, 
		RULE_secondLevelBinaryArithmeticOp = 30, RULE_firstLevelBinaryRelationalOp = 31, 
		RULE_secondLevelBinaryRelationalOp = 32;
	public static final String[] ruleNames = {
		"main", "ftDcl", "funcDcl", "typeBrace", "args", "argsVar", "typeDcl", 
		"varDef", "varVal", "ftDef", "typeDef", "component", "accessModifier", 
		"funcDef", "block", "stmt", "assign", "var", "ref", "expr", "funcCall", 
		"list", "handleCall", "params", "condStmt", "loopStmt", "type", "constVal", 
		"unaryOp", "firstLevelBinaryArithmeticOp", "secondLevelBinaryArithmeticOp", 
		"firstLevelBinaryRelationalOp", "secondLevelBinaryRelationalOp"
	};
	...
	private static final String[] _LITERAL_NAMES = {
		...
		"'public'", "'read'", "'return'", "'string'", "'super'", "'switch'", "'this'", 
		"'type'", "'while'", "'write'", "'=='", "'!='", "'<='", "'<'", "'>'", 
		"'>='", "'~'", "'|'", "'&'", "'^'", "'||'", "'&&'", "'!'", "'-'", "'+'", 
		"'*'", "'/'", "'%'", "'='", "'{'", "'}'", "'('", "')'", "'['", "']'", 
		"'.'", "','", "':'", "';'"
	...
	public static class TypeBraceContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_typeBrace; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterTypeBrace(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitTypeBrace(this);
		}
	}
	...
	public static class CONDSTMTAltContext extends StmtContext {
		...
		public CONDSTMTAltContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterCONDSTMTAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitCONDSTMTAlt(this);
		}
	}
	public static class CONTINUEAltContext extends StmtContext {
		...
		public TerminalNode SEMICOLON() { return getToken(Lulu2Parser.SEMICOLON, 0); }
		public CONTINUEAltContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterCONTINUEAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitCONTINUEAlt(this);
		}
	}
	public static class RETURNAltContext extends StmtContext {
		public TerminalNode RETURN() { return getToken(Lulu2Parser.RETURN, 0); }
		public TerminalNode SEMICOLON() { return getToken(Lulu2Parser.SEMICOLON, 0); }
		public RETURNAltContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterRETURNAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitRETURNAlt(this);
		}
	}
	public static class LOOPSTMTAltContext extends StmtContext {
		...
		public LOOPSTMTAltContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterLOOPSTMTAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitLOOPSTMTAlt(this);
		}
	}
	public static class FUNCCALLSTMTAltContext extends StmtContext {
		...
		public TerminalNode SEMICOLON() { return getToken(Lulu2Parser.SEMICOLON, 0); }
		public FUNCCALLSTMTAltContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterFUNCCALLSTMTAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitFUNCCALLSTMTAlt(this);
		}
	}
	public static class BREAKAltContext extends StmtContext {
		public TerminalNode BREAK() { return getToken(Lulu2Parser.BREAK, 0); }
		public TerminalNode SEMICOLON() { return getToken(Lulu2Parser.SEMICOLON, 0); }
		public BREAKAltContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterBREAKAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitBREAKAlt(this);
		}
	}
	public static class DESTRUCTAltContext extends StmtContext {
		...
		public DESTRUCTAltContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterDESTRUCTAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitDESTRUCTAlt(this);
		}
	}
	public static class ASSIGNAltContext extends StmtContext {
		...
		public TerminalNode SEMICOLON() { return getToken(Lulu2Parser.SEMICOLON, 0); }
		public ASSIGNAltContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterASSIGNAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitASSIGNAlt(this);
		}
	}
		...
		try {
			...
			case 2:
				...
				((ExprContext)_localctx).expr = expr(16);
				        ...
				        {
				            LuluListener.currentNode.throwError(new CompileError("bad operand types for unary operator " + (((ExprContext)_localctx).unaryOp!=null?_input.getText(((ExprContext)_localctx).unaryOp.start,((ExprContext)_localctx).unaryOp.stop):null) + " "));
				            ((ExprContext)_localctx).t =  null;
				        }
				        else ((ExprContext)_localctx).t =  Type.Int();
			...
			case 4:
				...
				((ExprContext)_localctx).handleCall = handleCall();
				        ...
				        else ((ExprContext)_localctx).t =  type;
				...
				if ( _alt==1 ) {
					...
					case 1:
						...
						((ExprContext)_localctx).b = ((ExprContext)_localctx).expr = expr(16);
						                  ...
						                  {
						                      LuluListener.currentNode.throwError(new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).firstLevelBinaryArithmeticOp!=null?_input.getText(((ExprContext)_localctx).firstLevelBinaryArithmeticOp.start,((ExprContext)_localctx).firstLevelBinaryArithmeticOp.stop):null) + " "));
						                      ((ExprContext)_localctx).t =  null;
						                  }
						                  else
						                  {
						                      if(((ExprContext)_localctx).a.t == ((ExprContext)_localctx).b.t) ((ExprContext)_localctx).t =  ((ExprContext)_localctx).a.t;
						                      else
						                          switch(((ExprContext)_localctx).a.t.getTypeEnum())
						                          {
						                              case Int:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
						                                  {
						                                      case Float: ((ExprContext)_localctx).t =  Type.Float();
						                                          break;
						                                      case Bool: ((ExprContext)_localctx).t =  Type.Int();
						                                          break;
						                                      case string: ((ExprContext)_localctx).t =  Type.String();
						                                          break;
						                                      default: throw new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).firstLevelBinaryArithmeticOp!=null?_input.getText(((ExprContext)_localctx).firstLevelBinaryArithmeticOp.start,((ExprContext)_localctx).firstLevelBinaryArithmeticOp.stop):null) + " ");
						                                  }
						                                  break;
						                              case Float:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
						                                  {
						                                      case Bool: ((ExprContext)_localctx).t =  Type.Float();
						                                          break;
						                                      case Int: ((ExprContext)_localctx).t =  Type.Float();
						                                          break;
						                                      default: throw new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).firstLevelBinaryArithmeticOp!=null?_input.getText(((ExprContext)_localctx).firstLevelBinaryArithmeticOp.start,((ExprContext)_localctx).firstLevelBinaryArithmeticOp.stop):null) + " ");
						                                  }
						                                  break;
						                              case Bool:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
						                                  {
						                                      case Float: ((ExprContext)_localctx).t =  Type.Float();
						                                          break;
						                                      case Int: ((ExprContext)_localctx).t =  Type.Int();
						                                          break;
						                                      case string: ((ExprContext)_localctx).t =  Type.String();
						                                          break;
						                                      default: throw new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).firstLevelBinaryArithmeticOp!=null?_input.getText(((ExprContext)_localctx).firstLevelBinaryArithmeticOp.start,((ExprContext)_localctx).firstLevelBinaryArithmeticOp.stop):null) + " ");
						                              ...
						                              case string:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
						                                  {
						                                      case Bool: ((ExprContext)_localctx).t =  Type.String();
						                                          break;
						                                      case Int :((ExprContext)_localctx).t =  Type.String();
						                                          break;
						                                      default: throw new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).firstLevelBinaryArithmeticOp!=null?_input.getText(((ExprContext)_localctx).firstLevelBinaryArithmeticOp.start,((ExprContext)_localctx).firstLevelBinaryArithmeticOp.stop):null) + " ");
						                                  }
						                                  break;
					...
					case 2:
						...
						((ExprContext)_localctx).b = ((ExprContext)_localctx).expr = expr(15);
						                  ...
						                  if(!(((ExprContext)_localctx).a.t instanceof Type.PrimitiveType) || !(((ExprContext)_localctx).b.t instanceof Type.PrimitiveType))
						                  {
						                      LuluListener.currentNode.throwError(new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).secondLevelBinaryArithmeticOp!=null?_input.getText(((ExprContext)_localctx).secondLevelBinaryArithmeticOp.start,((ExprContext)_localctx).secondLevelBinaryArithmeticOp.stop):null) + " "));
						                      ((ExprContext)_localctx).t =  null;
						                  }
						                  else
						                  {
						                          ...
						                          switch(((ExprContext)_localctx).a.t.getTypeEnum())
						                          {
						                              case Int:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
						                                  {
						                                      ...
						                                      case string: ((ExprContext)_localctx).t =  Type.String();
						                                          break;
						                                      default: throw new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).secondLevelBinaryArithmeticOp!=null?_input.getText(((ExprContext)_localctx).secondLevelBinaryArithmeticOp.start,((ExprContext)_localctx).secondLevelBinaryArithmeticOp.stop):null) + " ");
						                                  }
						                                  break;
						                              case Float:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
					...
					case 3:
						...
						((ExprContext)_localctx).b = ((ExprContext)_localctx).expr = expr(14);
						                  ...
						                  if(!(((ExprContext)_localctx).a.t instanceof Type.PrimitiveType) || !(((ExprContext)_localctx).b.t instanceof Type.PrimitiveType))
						                  {
						                      LuluListener.currentNode.throwError(new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).firstLevelBinaryRelationalOp!=null?_input.getText(((ExprContext)_localctx).firstLevelBinaryRelationalOp.start,((ExprContext)_localctx).firstLevelBinaryRelationalOp.stop):null) + " "));
						                      ((ExprContext)_localctx).t =  null;
						                  }
						                  else
						                  {
						                      if(((ExprContext)_localctx).a.t == ((ExprContext)_localctx).b.t) ((ExprContext)_localctx).t =  Type.Bool();
						                      else
						                          switch(((ExprContext)_localctx).a.t.getTypeEnum())
						                          {
						                              case Int:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
						                                  {
						                                      case Float: ((ExprContext)_localctx).t =  Type.Bool();
						                                          break;
						                                      case Bool: ((ExprContext)_localctx).t =  Type.Bool();
						                                          break;
						                                      case string: ((ExprContext)_localctx).t =  Type.Bool();
						                                          break;
						                                      default: throw new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).firstLevelBinaryRelationalOp!=null?_input.getText(((ExprContext)_localctx).firstLevelBinaryRelationalOp.start,((ExprContext)_localctx).firstLevelBinaryRelationalOp.stop):null) + " ");
						                                  }
						                                  break;
						                              case Float:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
						                                  {
						                                      case Bool: ((ExprContext)_localctx).t =  Type.Bool();
						                                          break;
						                                      case Int: ((ExprContext)_localctx).t =  Type.Bool();
						                                          break;
						                                      default: throw new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).firstLevelBinaryRelationalOp!=null?_input.getText(((ExprContext)_localctx).firstLevelBinaryRelationalOp.start,((ExprContext)_localctx).firstLevelBinaryRelationalOp.stop):null) + " ");
						                                  }
						                                  break;
					...
					case 4:
						...
						((ExprContext)_localctx).b = ((ExprContext)_localctx).expr = expr(13);
						                  ...
						                  if(!(((ExprContext)_localctx).a.t instanceof Type.PrimitiveType) || !(((ExprContext)_localctx).b.t instanceof Type.PrimitiveType))
						                  {
						                      LuluListener.currentNode.throwError(new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).secondLevelBinaryRelationalOp!=null?_input.getText(((ExprContext)_localctx).secondLevelBinaryRelationalOp.start,((ExprContext)_localctx).secondLevelBinaryRelationalOp.stop):null) + " "));
						                      ((ExprContext)_localctx).t =  null;
						                  }
						                  else
						                  {
						                          ...
						                          switch(((ExprContext)_localctx).a.t.getTypeEnum())
						                          {
						                              case Int:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
						                                  {
						                                      ...
						                                      case string: ((ExprContext)_localctx).t =  Type.Bool();
						                                          break;
						                                      default: throw new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).secondLevelBinaryRelationalOp!=null?_input.getText(((ExprContext)_localctx).secondLevelBinaryRelationalOp.start,((ExprContext)_localctx).secondLevelBinaryRelationalOp.stop):null) + " ");
						                                    }
						                                  break;
						                              case Float:
						                                  switch(((ExprContext)_localctx).b.t.getTypeEnum())
					...
					case 5:
						...
						((ExprContext)_localctx).b = ((ExprContext)_localctx).expr = expr(12);
						                  ...
						                  if((((ExprContext)_localctx).a.t==Type.Int() || ((ExprContext)_localctx).a.t==Type.Bool()) && (((ExprContext)_localctx).b.t==Type.Int() || ((ExprContext)_localctx).b.t==Type.Bool())) ((ExprContext)_localctx).t =  Type.Int();
						                  else
						                  {
						                      LuluListener.currentNode.throwError(new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).BitwiseAnd!=null?((ExprContext)_localctx).BitwiseAnd.getText():null) + " "));
						                      ((ExprContext)_localctx).t =  null;
						                  }
					...
					case 6:
						...
						((ExprContext)_localctx).b = ((ExprContext)_localctx).expr = expr(11);
						                  ...
						                  {
						                      LuluListener.currentNode.throwError(new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).BitwiseLogicalXor!=null?((ExprContext)_localctx).BitwiseLogicalXor.getText():null) + " "));
						                      ((ExprContext)_localctx).t =  null;
						                  }
					...
					case 7:
						...
						((ExprContext)_localctx).b = ((ExprContext)_localctx).expr = expr(10);
						                  ...
						                  {
						                      LuluListener.currentNode.throwError(new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).BitwiseOr!=null?((ExprContext)_localctx).BitwiseOr.getText():null) + " "));
						                      ((ExprContext)_localctx).t =  null;
						                  }
					...
					case 8:
						...
						((ExprContext)_localctx).b = ((ExprContext)_localctx).expr = expr(9);
						                  ...
						                  if((((ExprContext)_localctx).a.t==Type.Int() || ((ExprContext)_localctx).a.t==Type.Bool()) && (((ExprContext)_localctx).b.t==Type.Int() || ((ExprContext)_localctx).b.t==Type.Bool())) ((ExprContext)_localctx).t =  Type.Bool();
						                  else
						                  {
						                      LuluListener.currentNode.throwError(new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).LogicalAnd!=null?((ExprContext)_localctx).LogicalAnd.getText():null) + " "));
						                      ((ExprContext)_localctx).t =  null;
						                  }
					...
					case 9:
						...
						((ExprContext)_localctx).b = ((ExprContext)_localctx).expr = expr(8);
						                  ...
						                  {
						                      LuluListener.currentNode.throwError(new CompileError("bad operand types for binary operator " + (((ExprContext)_localctx).LogicalOr!=null?((ExprContext)_localctx).LogicalOr.getText():null) + " "));
						                      ((ExprContext)_localctx).t =  null;
						                  }
	...
	public static class METHODCALLAltContext extends FuncCallContext {
		...
		public METHODCALLAltContext(FuncCallContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterMETHODCALLAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitMETHODCALLAlt(this);
		}
	}
	public static class READAltContext extends FuncCallContext {
		...
		public TerminalNode ClosePar() { return getToken(Lulu2Parser.ClosePar, 0); }
		public READAltContext(FuncCallContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterREADAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitREADAlt(this);
		}
	}
	public static class WRITEAltContext extends FuncCallContext {
		...
		public TerminalNode ClosePar() { return getToken(Lulu2Parser.ClosePar, 0); }
		public WRITEAltContext(FuncCallContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterWRITEAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).exitWRITEAlt(this);
		}
	}
		...
		try {
			...
			match(CloseBrace);
			        ...
			        if(!((ListContext)_localctx).b.stream().map(t -> t.t).allMatch(t -> type == t))
			        {
			            ...
			            ((ListContext)_localctx).listType =  new Array(((ListContext)_localctx).a.t, ((ListContext)_localctx).b.size() + 1);
	...
	public static class SWITCHAltContext extends CondStmtContext {
		...
		public SWITCHAltContext(CondStmtContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener).enterSWITCHAlt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Lulu2Listener ) ((Lulu2Listener)listener